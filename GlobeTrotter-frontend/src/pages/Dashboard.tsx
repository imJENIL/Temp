...
import { deleteCreatedTrip, getCreatedTrips, subscribeToTrips } from "../services/tripStore";
...
export function Dashboard() {
  ...
  const handleDeleteTrip = (trip: Trip) => {
    const confirmed = window.confirm(`Delete "${trip.name}"? This will permanently remove the trip and its planned activities.`);
    if (!confirmed) return;
    deleteCreatedTrip(trip.id);
  };
